...
argument_parser.add_argument("--convexnext_dataset_path",default = r"D:\FOLDER_OF_FINAL_BACHELOR_THESIS\convexnet_hit_dataset",help="Please, write output path where ConvexNeXt dataset will be created")
